...
const DetailAnime = () => {
    ...
    const getAnime = async () => {
        ...
        setDetailAnime({title, synopsis, thumb, second_title, rating, followed, type, status, studio, released, duration, season, episode, fansub});
                ...
                <div className="flex">
                    {
                        ...
                        : <div className="flex-[0_0_100%]">
                            <iframe  allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="640" height="360" src={anime.video}></iframe>
                        </div>
                    }
                </div>
                    ...
                    <div className="text-white flex-1 font-mono">
                        <div className="flex justify-between">
                            <div className="detail-text-title">
                                ...
                                <p className="text-[#b7b7b7] mb-3">{detailAnime.second_title}</p>
                            </div>
                            <div className="detail-text-rating">
                                <div className="rating-container">
                                    <span style={{ width: `${detailAnime.rating}%` }}></span>
                                </div>
                                <p className="text-sm text-[#b7b7b7]">Rating : { detailAnime.rating}</p>
                            </div>
                        </div>
                        <p className="text-[#b7b7b7]" dangerouslySetInnerHTML={ { __html: detailAnime.synopsis } }></p>
                        <div className="flex mt-8">
                            ...
                            <ul>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                    <span className="w-[115px] inline-block text-[#b7b7b7]">Status:</span>
                                    { detailAnime.status }
                                </li>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                    <span className="w-[115px] inline-block text-[#b7b7b7]">Released:</span>
                                    { detailAnime.released }
                                </li>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                <span className="w-[115px] inline-block text-[#b7b7b7]">Season:</span>
                                { detailAnime.season }
                                </li>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                <span className="w-[115px] inline-block text-[#b7b7b7]">Episode:</span>
                                { detailAnime.episode }
                                </li>
                            </ul>
                            </div>
                            ...
                            <ul className="">
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                    <span className="w-[115px] inline-block text-[#b7b7b7]">Studio:</span>
                                    { detailAnime.studio }
                                </li>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                    <span className="w-[115px] inline-block text-[#b7b7b7]">Duration:</span>
                                    { detailAnime.duration }
                                </li>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                    <span className="w-[115px] inline-block text-[#b7b7b7]">Type:</span>
                                    { detailAnime.type }
                                </li>
                                <li className="relative text-[15px] text-[#fff] leading-8 pl-5 before:content-[''] before:absolute before:left-0 before:top-[12px] before:h-[6px] before:w-[6px] before:bg-[#b7b7b7]">
                                    <span className="w-[115px] inline-block text-[#b7b7b7]">Fansub:</span>
                                    { detailAnime.fansub }
                                </li>
          ...
          <div className="w-full h-[457px] bg-[#070720]">
            ...
            <div className="h-[357px] overflow-x-auto mt-14 scrollbar px-2">
            {
              ...
              downloads.map( (download, i) => (
                  <div className="text-white block border border-slate-400 mb-2 px-3 py-1 ml-4 rounded-md group" key={i}>
                            ...
                            <div>
                                { link.resolusi }
                                {
                                    link.data_url.map( (url) => (
                                        <span className="ml-3">
                                            <a href={url.url_download} target="_blank">{ url.url_name }</a> 
                                        </span>
                                    ))
                                }
                            </div>
