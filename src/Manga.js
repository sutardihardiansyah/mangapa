            ...
            <div className="grid grid-cols-1 2sm:grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-4 2sm:gap-x-36 gap-y-24 sm:gap-x-52 md:gap-y-44 lg:gap-y-20">
              {mangaList.map((manga, i) => (
                <>
                  <div
                    key={i}
                    className="w-[161px] h-[325px] xs:w-[193px] sm:w-[240px] md:w-80 lg:w-60"
                  >
                    <Link
                      to={`/manga/detail/${manga.endpoint}`}
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 w-full h-16 manga-title transition-all duration-500 group-hover:h-24">
                        <h4 className="text-white overflow-ellipsis overflow-hidden whitespace-nowrap font-bold">
                          {manga.title}
                        </h4>
                      </div>
                    </Link>
                    ...
                    <Link
                      className="text-white block rounded-bl-md rounded-br-md bg-black h-[80px] border-t-2 border-white hover:bg-sky-700"
                      to={`/manga/chapter/${manga.chapter_endpoint}`}
                    >
